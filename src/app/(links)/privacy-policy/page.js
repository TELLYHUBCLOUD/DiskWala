...
export const metadata = {
  title: "Privacy Policy - TheDiskWala",
  description:
    "This Privacy Policy document contains types of information that is collected and recorded by thediskwala.com and how we use it.",
  robots: "index, follow",
  openGraph: {
    title: "Privacy Policy - TheDiskWala",
    description: "Privacy Policy page.",
    type: "website",
    url: "https://thediskwala.com/privacy-policy",
    images: ["/og.jpg"],
  },
};
    ...
    <div className="space-y-8">
      <section className="space-y-4">
        <p className="text-lg leading-relaxed">
          At thediskwala.com, accessible from{" "}
          <a href="https://thediskwala.com" className="text-blue-600 dark:text-blue-400 hover:underline">
            https://thediskwala.com
          </a>
          , one of our main priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by thediskwala.com and how we use it.
        </p>
        <p className="text-lg leading-relaxed">
        ...
        <p className="text-lg leading-relaxed">
          ...
          shared and/or collect in thediskwala.com. This policy is not applicable
        ...
        <p className="text-lg leading-relaxed">
          thediskwala.com follows a standard procedure of using log files. These
        ...
        <p className="text-lg leading-relaxed">
          Like any other website, thediskwala.com uses "cookies". These cookies are
        ...
        <p className="text-lg leading-relaxed">
          ...
          advertising partners of thediskwala.com.
        </p>
        <p className="text-lg leading-relaxed">
          Third-party ad servers or ad networks use technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on thediskwala.com, which are sent
        ...
        <p className="text-lg leading-relaxed">
          Note that thediskwala.com has no access to or control over these cookies
        ...
        <p className="text-lg leading-relaxed">
          thediskwala.com's Privacy Policy does not apply to other advertisers or
        ...
        <p className="text-lg leading-relaxed">
          thediskwala.com does not knowingly collect any Personal Identifiable
