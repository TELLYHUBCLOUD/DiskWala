  ...
  return (
    <div className="min-h-screen bg-white from-black-400 to-white-600 text-black p-6">
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="bg-white backdrop-blur-lg rounded-2xl p-4 shadow-xl border border-slate-700" style={{marginTop : '10px'}}>
...
<div id="ad-container" className="my-4">
  <div>
<script type="text/javascript" src="//cdn.runative-syndicate.com/sdk/v1/bi.js" data-ts-spot="39faec82ab9542afa76743729ca802b0" data-ts-width="300" data-ts-height="100"  async defer></script>
  </div>
</div>
{/* End of Ad Code */}
